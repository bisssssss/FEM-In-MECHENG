...
//coding style and comment, explain your code
//clean template comments
//unit tests
//save constant basis functions for each bi-unit element
//H1 norm (12 plots)
// L2 norm (12 plots)
//submit vtk file along with .h5 files
