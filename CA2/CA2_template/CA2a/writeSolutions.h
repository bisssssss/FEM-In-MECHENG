...
void writeSolutionsToFileCA2_1(const Vector<double>& U, std::string solutionTag){
  hid_t file_id, dataset_id, dataspace_id;
  herr_t      status;
  hsize_t dimens_1d;
  std::cout << "writing solution for Coding Assignment 2, prob 1 to file : " << solutionTag.c_str() << ".h5" << std::endl;
...
void writeSolutionsToFileCA2_2(const Vector<double>& U, double l2Norm, std::string solutionTag){
  hid_t file_id, dataset_id, dataspace_id;
  herr_t      status;
  hsize_t dimens_1d;
  std::cout << "writing solution for Coding Assignment 2, prob 2 to file : " << solutionTag.c_str() << ".h5" << std::endl;
